...
define("ace/test/user", ["require", "exports", "module"], function (
	require,
	exports,
	module
) {
	...
	function sendKey(letter, timeout) {
		var keyCode =
			controlKeys[letter] || printableKeys[letter] || shiftedKeys[letter];
	...
	function type() {
		...
		for (var i = 0; i < keys.length; i++) {
			...
			if (key.length > 1) {
				var isKeyName =
					controlKeys[key] || printableKeys[key] || shiftedKeys[key];
				if (!isKeyName) {
					var parts = key.split("-");
...
define("ace/test/asyncjs/assert", [
	"require",
	"exports",
	"module",
	"ace/lib/oop",
...
define("ace/test/asyncjs/async", ["require", "exports", "module"], function (
	require,
	exports,
	module
) {
...
define("ace/test/mockrenderer", ["require", "exports", "module"], function (
	require,
	exports,
	module
) {
...
define("kitchen-sink/dev_util", [
	...
	exports.openLogView = function () {
		...
		if (!logSession) {
			logSession = new EditSession(
				localStorage.lastTestCase || "",
				"ace/mode/javascript"
			);
	...
	exports.getUI = function (container) {
		return [
			...
			[
				"button",
				{ "aria-label": "Open Log View", onclick: exports.openLogView },
				"O",
			],
			...
			[
				"button",
				{ "aria-label": "Close Log View", onclick: exports.closeLogView },
				"X",
			],
		];
	};
...
define("kitchen-sink/doclist", [
	...
	if (window.define && window.define.modules)
		try {
	...
	function loadDoc(name, callback) {
		...
		else if (parts[0] == "ace") path = "src/" + parts.slice(1).join("/");
...
define("ace/marker_group", ["require", "exports", "module"], function (
	require,
	exports,
	module
) {
...
define("kitchen-sink/demo", [
	...
	function loadLanguageProvider(editor) {
		...
		loadScript(function (LanguageProvider) {
			var languageProvider = LanguageProvider.fromCdn(
				"https://mkslanc.github.io/ace-linters/build",
				{
					functionality: {
						hover: true,
						completion: {
	...
	function openTestDialog(animateHeight) {
		if (window.dialogEditor) window.dialogEditor.destroy();
		...
		var dialog = dom.buildDom(
			[
				"div",
				{
					style:
						"transition: all 1s; position: fixed; z-index: 100000;" +
		...
		editor.focus();
		editor.commands.bindKey("Esc", function () {
			close();
		});
	}
